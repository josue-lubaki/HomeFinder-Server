...
private fun houseDto(
    ...
    isFeature = house.isFeature,
    rating = house.rating,
    isSold = house.isSold,
    toRent = house.toRent,
    toSell = house.toSell,
    isHeating = house.isHeating,
    isFurnished = house.isFurnished,
    isPetFriendly = house.isPetFriendly,
    hasAirConditioning = house.hasAirConditioning,
    hasInternetAccess = house.hasInternetAccess,
