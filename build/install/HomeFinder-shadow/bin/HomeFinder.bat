...
set CLASSPATH=%APP_HOME%\lib\HomeFinder-all.jar

@rem Execute HomeFinder
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HOME_FINDER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%HOME_FINDER_EXIT_CONSOLE%" exit 1
exit /b 1
